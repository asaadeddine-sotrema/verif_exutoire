...
def charger_suez_terrain(f, type_fichier):
    ...
    try:
        ...
        if isinstance(f, str):
            # If it's a path (for testing), read it directly
            # logic in app.py reads header via checking rows
...
# Test with the file
f_path = "source/SUEZ/SUEZ_CTC_S2S5_JAN2026.xls"
df = charger_suez_terrain(f_path, "CTC")
